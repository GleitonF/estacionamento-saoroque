...
import 'package:flutter_aplication_estacionamento/Cadastro_sucesso.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 10),
              Text('Passo 3 de 3', style: TextStyle(
                fontSize: 16
              )),
              SizedBox(height: 50),
              ...
              SizedBox(height: 50),
              Padding( //Este padding é a caixa de checkbox
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => CadastroSucesso(title: 'teste')),
                  );
                },
                child: Container(
                  height: 42,
